  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="relative overflow-hidden bg-ramadan-hero px-4 pt-12 pb-10 lg:pt-20 lg:pb-16">
        {/* Decorative elements */}
        <div className="absolute top-6 right-8 text-ramadan-gold/20">
          <Moon className="h-32 w-32 lg:h-48 lg:w-48" />
        </div>
        <div className="absolute bottom-4 left-6 text-ramadan-gold/10">
          <Star className="h-20 w-20" />
        </div>
        <div className="absolute top-1/3 left-1/4 w-2 h-2 bg-ramadan-gold/30 rounded-full" />
        <div className="absolute top-1/4 right-1/3 w-1.5 h-1.5 bg-ramadan-gold/20 rounded-full" />
        <div className="absolute bottom-1/3 right-1/4 w-1 h-1 bg-white/20 rounded-full" />

        <div className="content-container text-center relative z-10">
          <div className="w-20 h-20 lg:w-24 lg:h-24 bg-ramadan-gold/20 backdrop-blur-sm rounded-3xl flex items-center justify-center mx-auto mb-6 glow-gold border border-ramadan-gold/30">
          ...
          <p className="text-base lg:text-lg text-white/70 mb-8 leading-relaxed max-w-md mx-auto">
            Reserve your seat at the e& Egypt Ramadan Tent for Iftar & Suhoor
          </p>
          <div className="max-w-sm mx-auto space-y-3">
            <Link href="/tent-registration" className="block">
              <Button size="lg" className="w-full text-base py-6 rounded-2xl bg-ramadan-gold hover:bg-ramadan-gold/90 text-eand-ocean shadow-lg shadow-ramadan-gold/25 active:scale-[0.98] transition-all font-semibold">
      ...
      <section className="flex-1 bg-ramadan-subtle px-4 py-8 lg:py-12">
        <div className="content-container space-y-4">
          <h2 className="text-xs font-semibold text-eand-grey uppercase tracking-wider px-1">
            Ramadan Activities
          </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <Link href="/riddles" className="block">
              <Card className="border-0 shadow-md hover:shadow-lg active:scale-[0.99] transition-all bg-white rounded-2xl overflow-hidden">
                <CardContent className="p-5 flex items-center gap-4">
                  <div className="w-14 h-14 bg-eand-ocean rounded-2xl flex items-center justify-center flex-shrink-0">
                  ...
                  <ChevronRight className="h-5 w-5 text-eand-med-grey flex-shrink-0" />
                </CardContent>
              </Card>
            </Link>
            ...
            <Link href="/wellness" className="block">
              <Card className="border-0 shadow-md hover:shadow-lg active:scale-[0.99] transition-all bg-white rounded-2xl overflow-hidden">
                <CardContent className="p-5 flex items-center gap-4">
                  <div className="w-14 h-14 bg-eand-dark-green rounded-2xl flex items-center justify-center flex-shrink-0">
