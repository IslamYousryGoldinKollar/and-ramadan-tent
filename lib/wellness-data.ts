...
export const WELLNESS_CATEGORIES: WellnessCategory[] = [
  {
    ...
    topics: [
      ...
      {
        id: 'nutrition',
        title: 'Nutrition & Smart Eating',
        icon: 'Sun',
        content: 'What you eat during Ramadan matters more than how much. Strategic food choices at Suhoor and Iftar can make the difference between a productive day and a miserable one.',
        items: [
          { title: 'The Suhoor Foundation', desc: 'Start with foul medames (Egyptian fava beans), eggs, and whole wheat bread. These complex carbs and proteins release energy slowly and keep you full through the afternoon.' },
          { title: 'Break Fast Gently', desc: 'Follow the Sunnah: start with dates and water, then a light soup, then wait 15-20 minutes before the main meal. This prevents the stomach shock that causes bloating and lethargy.' },
          { title: 'The Protein Priority', desc: 'Include protein in every meal — eggs, beans, lentils, chicken, or yogurt. Protein stabilizes blood sugar and prevents the energy crashes that make fasting harder.' },
          { title: 'Avoid the Sugar Trap', desc: 'Kunafa, qatayef, and basbousa are beloved but eating sweets right after Iftar spikes blood sugar then crashes it. Enjoy desserts 2 hours after your meal instead.' },
          { title: 'Portion Control', desc: 'Your stomach shrinks during fasting. Use a smaller plate and eat slowly — it takes 20 minutes for your brain to register fullness. Overeating leads to discomfort and poor sleep.' },
        ],
      },
      {
        id: 'health-issues',
        ...
        icon: 'BookOpen',
        content: 'Fasting can bring out minor health issues if you are not prepared. Knowing what to expect and how to prevent common problems makes your Ramadan much smoother.',
        items: [
          { title: 'Headache Prevention', desc: 'Most Ramadan headaches come from caffeine withdrawal or dehydration. Gradually reduce caffeine the week before Ramadan and stay well-hydrated between Iftar and Suhoor.' },
          { title: 'Acidity & Heartburn', desc: 'Avoid heavy fried foods, excessive spice, and carbonated drinks at Iftar. A glass of cold milk or a few almonds can coat the stomach and ease discomfort.' },
          { title: 'Constipation Relief', desc: 'Fiber is essential. Eat salads with every meal, have dried figs or prunes at Suhoor, and drink plenty of water between meals to keep your digestion regular.' },
          { title: 'Low Blood Sugar Signs', desc: 'Feeling shaky, extremely dizzy, or confused may indicate dangerously low blood sugar. People with diabetes or chronic conditions should consult their doctor before fasting.' },
          { title: 'Eye Strain & Fatigue', desc: 'Fasting can tire your eyes faster during screen work. Follow the 20-20-20 rule: every 20 minutes, look at something 20 feet away for 20 seconds.' },
        ],
      },
    ],
  },
  {
    ...
    topics: [
      ...
      },
      {
        ...
        icon: 'Smartphone',
        content: 'Your phone consumes more mental energy than you realize — especially when fasting. Managing digital habits during Ramadan protects your clarity and inner peace.',
        items: [
          { title: 'The Notification Fast', desc: 'Turn off non-essential notifications during fasting hours. Every ping pulls your attention and drains mental energy you cannot replenish until Iftar.' },
          { title: 'Curate Your Feed', desc: 'Mute accounts that cause stress or negativity. Fill your feed with Quran recitations, educational content, and positive reminders during the holy month.' },
          { title: 'Screen-Free Iftar', desc: 'Put all phones away during Iftar. Breaking fast is a sacred moment of gratitude — give it your full attention and be present with the people around you.' },
          { title: 'The Evening Cutoff', desc: 'Set a screen time limit after Isha. Switch to reading, family conversation, or Taraweeh prayers. Your sleep quality will improve dramatically.' },
          { title: 'Mindful Sharing', desc: 'Before posting on social media, ask: is this for genuine benefit or for show? Ramadan is about sincerity. Share what benefits others, not what feeds the ego.' },
        ],
      },
      {
        id: 'work-life',
        ...
        icon: 'Clock',
        content: 'Balancing work demands with Ramadan routines takes planning. With the right strategies, you can stay productive while honoring the spirit of the month.',
        items: [
          { title: 'Communicate Early', desc: 'Let your manager and team know about your Ramadan routine. Most Egyptian workplaces are accommodating — a simple heads-up about adjusted energy levels goes a long way.' },
          { title: 'Front-Load Your Day', desc: 'Schedule demanding tasks for the morning when your Suhoor energy is highest. Save lighter work like emails and admin for the afternoon when energy dips.' },
          { title: 'The Iftar Boundary', desc: 'Iftar time is sacred and non-negotiable. Avoid scheduling meetings or calls near Maghrib. This is your moment to break fast in peace.' },
          { title: 'Weekend Meal Prep', desc: 'Spend part of your weekend preparing meals for the week. Freeze portions of soup, rice, and main dishes. This saves hours of evening cooking stress on work nights.' },
          { title: 'Use Flexible Hours', desc: 'Many Egyptian companies offer adjusted Ramadan working hours. Take advantage if available — even shifting by one hour can significantly help with energy management.' },
        ],
      },
    ],
  },
  {
    ...
    topics: [
      ...
      },
      {
        ...
        icon: 'Heart',
        content: 'Ramadan is the month of generosity. The act of giving — whether money, food, time, or kindness — purifies the heart and multiplies blessings.',
        items: [
          { title: 'Daily Sadaqah Habit', desc: 'Give even a small amount of charity each day before Iftar. Consistency matters more than the amount — make it a daily practice throughout the month.' },
          { title: 'Feed a Fasting Person', desc: 'The Prophet (peace be upon him) said whoever provides Iftar for a fasting person earns the same reward. Share food with a neighbor, colleague, or someone in need.' },
          { title: 'Give Your Time', desc: 'Charity is not only money. Visit an elderly relative, help at a local mosque, teach a child Quran, or simply be there for someone who needs to talk.' },
          { title: 'Silent Charity', desc: 'The most rewarded charity is what is given quietly. Help someone anonymously — cover a grocery bill, leave food at a doorstep, or settle a small debt without fanfare.' },
          { title: 'Plan Your Zakat', desc: 'Many Egyptians pay their Zakat during Ramadan. Calculate it early, plan your distribution thoughtfully, and remember that close relatives in need have priority.' },
        ],
      },
      {
        id: 'family',
        title: 'Family & Home',
        icon: 'Home',
        content: 'Ramadan is a time to return to family. The shared Iftars, late-night conversations, and collective prayers create bonds that last far beyond the holy month.',
        items: [
          { title: 'Family Iftar Nights', desc: 'Dedicate at least 2-3 evenings a week for family Iftar at home. No phones, no TV during the meal — just food, conversation, and togetherness.' },
          { title: 'Involve the Children', desc: 'Let kids help set the Iftar table, arrange the dates, or pour the water. It teaches them the value of Ramadan and gives them a sense of belonging and pride.' },
          { title: 'Call Your Parents Daily', desc: 'If your parents are not nearby, call them every day during Ramadan. Ask about their health, their Iftar, their day. This is birr al-walidayn at its simplest and most beautiful.' },
          { title: 'Mend Family Ties', desc: 'If there is a family dispute or distance, Ramadan is the time to bridge it. Be the bigger person and reach out — silat al-rahm is a duty, not a favor.' },
          { title: 'Create Shared Rituals', desc: 'Whether reading Quran after Fajr, having tea after Taraweeh, or a family walk — shared Ramadan routines become treasured traditions that children carry forward.' },
        ],
      },
    ],
  },
